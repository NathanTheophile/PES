...
{
    public sealed class MainMenuCustomMatchView : MonoBehaviour
    {
        ...
        private bool ResolveServices()
        {
            ...
            {
                UgsPlayerIdentityService lUgsService = FindAnyObjectByType<UgsPlayerIdentityService>();
                _PlayerIdentityServiceSource = lUgsService;
                _PlayerIdentityService = lUgsService;
            }
        ...
        private bool ResolvePartyLobbyService(bool pLogMissing)
        {
            ...
            {
                UgsCustomRelayLobbyService lUgsService = FindAnyObjectByType<UgsCustomRelayLobbyService>();
                _PartyLobbyServiceSource = lUgsService;
                _PartyLobbyService = lUgsService;
            }
        ...
        private void HookButtons()
        {
            if (_OpenButton != null)
            {
                _OpenButton.onClick.RemoveListener(OpenCustomMatchPanel);
                _OpenButton.onClick.AddListener(OpenCustomMatchPanel);
            }

            if (_HostButton != null)
            {
                _HostButton.onClick.RemoveListener(HostCustomMatch);
                _HostButton.onClick.AddListener(HostCustomMatch);
            }

            if (_JoinButton != null)
            {
                _JoinButton.onClick.RemoveListener(JoinCustomMatch);
                _JoinButton.onClick.AddListener(JoinCustomMatch);
            }

            if (_CancelButton != null)
            {
                _CancelButton.onClick.RemoveListener(CancelCustomMatch);
                _CancelButton.onClick.AddListener(CancelCustomMatch);
            }
        }

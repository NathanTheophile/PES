...
{
    internal static class TacticalAssetEditorUtility
    {
        #region _____________________________| CONSTANTS

        public const string SkillsFolder = "Assets/TacticalPort/Data/Skills";
        public const string StatesFolder = "Assets/TacticalPort/Data/States";
        public const string UnitsFolder = "Assets/TacticalPort/Data/Units";

...
{
    public sealed class CreateBattleUnitDefinitionWindow : EditorWindow
    {
        ...
        [SerializeField] private BattleTeam _Team = BattleTeam.Player;
        ...
        [MenuItem("TacticalPort/Create/Battle Unit Definition...")]
        public static void Open()
        {
            CreateBattleUnitDefinitionWindow lWindow = GetWindow<CreateBattleUnitDefinitionWindow>("Create Unit");
        ...
        private void OnGUI()
        {
            ...
            TacticalAssetEditorUtility.DrawTitle("Create Battle Unit Definition", TacticalAssetEditorUtility.UnitsFolder);
            ...
            _Team = (BattleTeam)EditorGUILayout.EnumPopup("Team", _Team);
            ...
            if (TacticalAssetEditorUtility.DrawCreateButton("Create Battle Unit Definition"))
                CreateAsset();
        }
        ...
        {
            SerializedObject lSerializedObject = TacticalAssetEditorUtility.CreateSerializedAsset(out BattleUnitDefinition lAsset);

            string lId = TacticalAssetEditorUtility.SanitizeId(_Id, TacticalAssetEditorUtility.SanitizeId(_DisplayName, "unit"));
            ...
            string lFileName = TacticalAssetEditorUtility.BuildFileName("Unit", lId, _DisplayName, "unit");
            TacticalAssetEditorUtility.CreateAsset(lAsset, TacticalAssetEditorUtility.UnitsFolder, lFileName);
            Close();
        }

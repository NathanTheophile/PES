...
namespace TacticalPort.EditorTools
{
    public sealed class Creator_Unit : EditorWindow
    {
        ...
        [SerializeField] private int _MobilityPerTurn = 4;
        [SerializeField] private int _EnergyPerTurn = 1;
        ...
        private void OnGUI()
        {
            ...
            _MobilityPerTurn = Mathf.Max(0, EditorGUILayout.IntField("Mobility / Turn", _MobilityPerTurn));
            _EnergyPerTurn = Mathf.Max(0, EditorGUILayout.IntField("Energy / Turn", _EnergyPerTurn));
            _Velocity = Mathf.Max(0, EditorGUILayout.IntField("Velocity", _Velocity));
            ...
            _GeneralDamagePercent = Mathf.Max(0, EditorGUILayout.IntField("General Damage %", _GeneralDamagePercent));
            ...
            _GeneralResistancePercent = Mathf.Clamp(EditorGUILayout.IntField("General Resistance %", _GeneralResistancePercent), 0, 100);
        ...
        private void CreateAsset()
        {
            ...
            SetInt(lSerializedObject, "_MobilityPerTurn", Mathf.Max(0, _MobilityPerTurn));
            SetInt(lSerializedObject, "_EnergyPerTurn", Mathf.Max(0, _EnergyPerTurn));
            SetInt(lSerializedObject, "_Velocity", Mathf.Max(0, _Velocity));
            ...
            SetInt(lSerializedObject, "_GeneralDamagePercent", Mathf.Max(0, _GeneralDamagePercent));
            ...
            SetInt(lSerializedObject, "_GeneralResistancePercent", Mathf.Clamp(_GeneralResistancePercent, 0, 100));
